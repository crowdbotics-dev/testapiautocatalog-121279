...
## Project Structure
    ...
    ├── testapiautocatalog_121279  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_121279`
...
2. Clone this repo and `cd testapiautocatalog_121279`
